...
WebAssembly
  .instantiate(preparedFile, info)
  .then((output) => {
    Module.asm = output.instance.exports;
  }, () => console.err("Failed to load"));
